...
<head>
    <meta charset="UTF-8">
    <title>Reporte de estado de giros</title>
...
<body>
    ...
    <table>
        <thead>
            <tr>
                <th>N°</th>
                <th>Estado del giro</th>
                <th>Descripción</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($estadoGiros as $index => $estado)
                <tr>
        ...
        <tfoot>
            <tr>
                <th colspan="3" class="text-center">Total de estados registrados: {{ count($estadoGiros) }}</th>
            </tr>
    </table>
